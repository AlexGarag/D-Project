 ...
 * сформировать набор титульных и физических параметров (далее - разовое решение,
 * РР - one-time solution, Ots. Смотри сущности Ots+FormOts), по которым удет осуществляться процесс
 * монтажа форм для печати тиража.
 */
